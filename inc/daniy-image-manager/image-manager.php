 ...
 * Last Change: 9:34 pm  27 Februari 2015
 */
 ...
 * 
 * Updates:
 * - Bugfix format_image_data() method using array_values() to reset array key numbering (1.7.7)
...
class DNY_Image_Manager {
  ...
  function format_image_data( $images ) {
    ...
    $images = array_values( $images ); // bugfix 1.7.7 reset array keys
    ...
    // filter with array_values() to reset array numbering --> bugfix 1.7.6 reset array keys
